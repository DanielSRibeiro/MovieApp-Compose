...
class MovieDetailViewModel @Inject constructor(
    ...
    private val movieId = savedStateHandle.get<Int>(key = Constants.MOVIE_DETAIL_ARGUMENTS_KEY)
    ...
    private fun checkedFavorite(checkedFavoriteUseCase: MovieDetailEvent.CheckedFavorite) {
